...
const proto=K.Kernel.prototype,retainedRun=proto.run,retainedEqual=proto.equal,retainedWhnf=proto.whnf,retainedNormal=proto.normal,retainedTick=proto.tick;
...
const report=evaluate(4000000,true,focusRows);
install(false);
console.log("KERNEL_RG_POST_SUPPORT_TAIL "+JSON.stringify({scopeMode,report}));

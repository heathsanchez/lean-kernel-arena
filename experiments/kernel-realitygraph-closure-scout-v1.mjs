...
let closureScout={attempted:0,completed:0,failed:0,last:null};
...
function install(enabled){
  ...
  proto.run=function(...args){
    ...
    closureScout={attempted:0,completed:0,failed:0,last:null};
...
install(false);
console.log("KERNEL_RG_CLOSURE_SCOUT "+JSON.stringify({arena_sha256:sha,result,closureScout}));

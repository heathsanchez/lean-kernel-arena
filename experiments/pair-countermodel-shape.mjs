...
"",
"def analyze_expr(exprs,root,names=None):",
...
"    consts=collections.Counter();appheads=collections.Counter();const_samples=[]",
"    if names is not None:",
"      for n in seen:",
"        tag,v=exprs[n]",
"        if tag=='const':",
"          if len(const_samples)<20: const_samples.append(v)",
"          if isinstance(v,dict):",
"            ni=v.get('name'); consts[names.get(ni,str(ni))]+=1",
"        if tag=='app':",
"          cur=n;arity=0",
"          while cur in exprs and exprs[cur][0]=='app':",

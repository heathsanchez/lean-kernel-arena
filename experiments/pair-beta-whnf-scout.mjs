...
function countHead(e){
  ...
  switch(sp.head[1]){
    case DECIDE:
      stats.headDecide++;
      if(stats.decideSamples.length<12)stats.decideSamples.push({

...
function install(enabled){
  ...
  proto.run=function(...args){
    ...
    this.__closedInferCache=new WeakMap();this.__closedInferClosed=new WeakMap();this.__eqProgress=new WeakMap();this.__skipPICalls=0;
...
install(false);
console.log("PAIR_PI_CYCLE_GUARD_THRESHOLDS "+JSON.stringify(thresholds));
...
console.log("PAIR_PI_CYCLE_GUARD "+JSON.stringify({thresholds,full}));
process.exit(0);

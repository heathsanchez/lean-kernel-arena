...
import "./structural-normal-cache-layer.mjs";
...
for(const name of ["init-prelude","perf/grind-ring-5","perf/shared-subterm"]){
  ...
  console.log("STRUCTURAL_NORMAL_SEPARATOR "+JSON.stringify({
    ...
    hits:sum("__structNormalHits"),stores:sum("__structNormalStores"),skipped:sum("__structNormalSkipped"),

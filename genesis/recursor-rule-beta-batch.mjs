...
const TARGETS=[
 ["perf/shared-subterm","ACCEPT"],["perf/church-numerals","ACCEPT"],["perf/args-before-unfold","ACCEPT"],
 ["perf/folded-constant-first","ACCEPT"],["perf/repeated-subproblem","ACCEPT"],["perf/discarded-argument-match","ACCEPT"],
...
const out={experiment:"recursor-rule-beta-batch",clean,rows};mkdirSync("genesis/evidence",{recursive:true});writeFileSync("genesis/evidence/recursor-rule-beta-batch.json",JSON.stringify(out,null,2)+"\n");
console.log("RECURSOR_RULE_BETA_BATCH "+JSON.stringify(out));if(!clean)process.exit(1);

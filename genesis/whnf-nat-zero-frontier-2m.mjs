...
p.result=function(...xs){const r=result0.apply(this,xs);r.__whnfNatZeroHits=this.__whnfNatZeroHits??0;return r;};
for(const name of ["init-prelude","perf/grind-ring-5"]){
  ...
  console.log("POST_ZERO_FRONTIER_2M "+JSON.stringify({name,status:r.status,reason:r.reason,steps:r.steps??null,
    frontier:r.frontier_declaration??null,hits:r.__whnfNatZeroHits,conversion:r.conversion_frontier??null}));
}
